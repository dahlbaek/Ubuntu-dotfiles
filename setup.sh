...
sudo apt-get update
sudo apt-get install chromium-browser curl i3 ipython3 lynx msmtp mutt neovim offlineimap python3-pandas python3-pip r-base ranger texlive-full urlview zathura
sudo -k
